...
\subsubsection[\fn{context:enableDane}]{\fn{context:enableDane()}}

Enables use of DANE with this context.
...
\subsubsection[\fn{ssl:setDane}]{\fn{ssl:setDane($name$)}}

Enables DANE and sets hostname. context:enableDane() must have been called.

\subsubsection[\fn{ssl:addTlsa}]{\fn{ssl:addTlsa($usage$, $selector$, $type$, $data$)}}

Adds one iitem of TLSA data.
